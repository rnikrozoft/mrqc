            ...
            <div class="col-xl-12 mb-5 mb-xl-0">
                <div class="card shadow">
                    ...
                    <?php if (isset($_GET['date'])) { ?>
                        ...
                        <?php
                            ...
                            <?php
                            $sql_SJF = "SELECT DISTINCT ord_id,all_time from detail where M_name != 'ไม่มี' AND date = '$_GET[date]' ORDER BY all_time ASC";
                            ...
                            <?php
                            $sql_PRI = "SELECT DISTINCT ord_id from detail where M_name != 'ไม่มี' AND date = '$_GET[date]' ORDER BY priority ASC ";
                            $stmt_PRI = $conn->connect()->prepare($sql_PRI);
                            $stmt_PRI->execute();
                            ?>
                ...
                <?php if(isset($_GET["date"])){ ?>
                    <div class="text-right">
                        <button class="btn mt-2 btn-primary checkAlgo" date="<?php echo $_GET["date"]; ?>">Save</button>
                    </div>
                <?php } ?>
            </div>
        </div>
