        ...
        <div class="card shadow">
            <div class="card-header border-0">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="mb-0">ลำดับคิวการซ่อมบำรุง (FCFS)</h3>
                    </div>
                </div>
            </div>
                                            ...
                                            where detail.ord_id = $_id ";
                                                ...
                                                <?php 
                                                 ...
                                                 ?>  
                                                    ...
                                                    <td>
                                                <?php 
                                                    $endTime = strtotime("+$sum[$l] 2minutes",strtotime($selectedTime));
...
<?php }else if($row["status"]=="SJF"){ ?>
  <?php
                            $sql_SJF = "SELECT DISTINCT ord_id,all_time from detail where M_name != 'ไม่มี' AND DATE(date)=CURDATE() ORDER BY all_time ASC";
                    ...
                    <div class="row align-items-center">
                    <div class="col">
                        <h3 class="mb-0">ลำดับคิวการซ่อมบำรุง (SJF)</h3>
                    </div>
                    </div>
                    </div>
                    <div class="table-responsive">
                                    ...
                                    <td>
                                                <?php 
                                                 ...
                                                 ?>  
                                                    ...
                                                    <td>
                                                <?php 
                                                    $endTime = strtotime("+$sum2 2minutes",strtotime($selectedTime));
                                                    echo $sumTime = date('h:i:s a',$endTime);
                                                ?>
                                                    </td>
      ...
      <?php }else{ ?>
<?php
                            $sql_PRI = "SELECT DISTINCT ord_id from detail where M_name != 'ไม่มี' AND DATE(date)=CURDATE() ORDER BY priority ASC ";
    ...
    <div class="col-xl-12 mb-5 mb-xl-0">
        <div class="card shadow">
            <div class="card-header border-0">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="mb-0">ลำดับคิวการซ่อมบำรุง (PRIORITY)</h3>
                    </div>
                </div>
            </div>
            <div class="table-responsive">
